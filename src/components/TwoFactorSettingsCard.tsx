...
export const TwoFactorSettingsCard: React.FC<TwoFactorSettingsCardProps> = ({
  ...
  return (
    <>
      ...
      {/* Modal de Configuração do Google Authenticator (QR Code e Validação) */}
      <AnimatePresence>
        {showSetupModal && setupData && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 p-4 backdrop-blur-md overflow-y-auto select-none"
