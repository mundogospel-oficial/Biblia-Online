...
export const BIBLICAL_SITUATION_CATEGORIES = [
  ...
  { id: 'cruzes', label: '✝️ Cruzes e Gólgota (Sem Pessoas)' },
  { id: 'cenarios', label: '🌄 Cenários e Sepulcro (Sem Pessoas)' },
  { id: 'simbolos', label: '👑 Símbolos e Animais (Sem Pessoas)' },
...
export const BIBLICAL_SITUATIONS: BiblicalSituation[] = [
  // 1. CRÚZES E GÓLGOTA (SEM PESSOAS)
  {
    ...
    category: 'cruzes',
    categoryLabel: 'Cruzes e Gólgota',
  ...
  // 2. CENÁRIOS E SEPULCRO (SEM PESSOAS)
  {
    ...
    category: 'cenarios',
    categoryLabel: 'Cenários e Sepulcro',
  ...
  // 3. SÍMBOLOS SAGRADOS E ANIMAIS (SEM PESSOAS)
  {
    ...
    category: 'simbolos',
    categoryLabel: 'Símbolos e Animais',
